...
var (
	submissionAllColumns            = []string{"id", "created_at", "updated_at", "name", "submitter", "content", "accepted_at", "rejected_at", "accepted", "rejected", "notes"}
	submissionColumnsWithoutDefault = []string{}
	submissionColumnsWithDefault    = []string{"id", "created_at", "updated_at", "name", "submitter", "content", "accepted_at", "rejected_at", "accepted", "rejected", "notes"}
